...
<html lang="en">
<head>
    <title>Code coverage report for src/matchers/has.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/matchers</a> has.ts
    </h1>
    <div class='clearfix'>
    ...
    selector.selectors.forEach(childSelector =&gt; {
        ...
        traverse(node, {
            enter (childNode: TSQueryNode, parentNode: TSQueryNode | null): void {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (parentNode != null) {
