...
var Walker = (function (_super) {
    ...
    Walker.prototype.visitCallExpression = function (node) {
        ...
        if (tsutils.isPropertyAccessExpression(expression)) {
            ...
            if ((name_1 === "getValue") && util_1.isReferenceType(type) && util_1.couldBeType(type.target, "BehaviorSubject")) {
    ...
    Walker.prototype.visitPropertyAccessExpression = function (node) {
        ...
        if ((name === "value") && util_1.isReferenceType(type) && util_1.couldBeType(type.target, "BehaviorSubject")) {
