...
var u = [
    ...
    [6,125],
    [41,44],
    [10,11,12,14,15,18,22,27,41,42,43,44,45,46,47,59,60,61,64,125],
    [10,11,12,14,15,18,22,27,41,42,43,44,45,47,59,60,61,125],
    [10,11,12,14,15,18,27,41,44,59,125],
    [10,11,12,14,15,18,22,27,41,43,44,45,59,60,61,125],
    [2,6,9,13,16,17,20,21,23,24,25,26,40,123,125,126],
    [6,19]
];
...
var parser = {
    ...
    //   parser table compression mode: ... 1
...
symbols_: {
  ...
  "expression": 49,
  "expressions": 36,
  "expressions_nonempty": 37,
  "expressions_semicolon": 38,
  "feature": 32,
  "feature_list": 31,
  "formal": 35,
  "formals": 33,
...
case 1:
    /*! Production::    program : class_list */

    this.$ = ["PROGRAM", {}, yyvstack[yysp]];
    //typeof console !== 'undefined' ? console.log(yyvstack[yysp]) : print(yyvstack[yysp]);
    return this.$;
    break;

case 2:
    /*! Production::    class_list : class ";" */

    this.$ = ["CLASS_LIST", {}, yyvstack[yysp - 1]];
    break;

case 3:
    /*! Production::    class_list : class_list class ";" */

    this.$ = appendChild(yyvstack[yysp - 2], yyvstack[yysp - 1]); parse_results = this.$;
    break;

case 4:
    /*! Production::    class_list : error ";" */
case 9:
    /*! Production::    feature_list : error ";" */
...
case 5:
    /*! Production::    class : CLASS TYPEID "{" feature_list "}" */

    this.$ = ["CLASS", {}, yyvstack[yysp - 3], "Object", yyvstack[yysp - 1]];
    break;

case 6:
    /*! Production::    class : CLASS TYPEID INHERITS TYPEID "{" feature_list "}" */

    this.$ = ["CLASS", {}, yyvstack[yysp - 5], yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 7:
    /*! Production::    feature_list : %epsilon */

    this.$ = ["FEATURES", {}];
    break;

case 8:
    /*! Production::    feature_list : feature_list feature ";" */
case 23:
    /*! Production::    expressions_semicolon : expressions_semicolon expression ";" */

    this.$ = appendChild(yyvstack[yysp - 2], yyvstack[yysp - 1]);
    break;

case 10:
    /*! Production::    feature : OBJECTID "(" formals ")" ":" TYPEID "{" expression "}" */

    this.$ = ["METHOD", {}, yyvstack[yysp - 8], yyvstack[yysp - 6], yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 11:
    /*! Production::    feature : OBJECTID ":" TYPEID ASSIGN expression */

    this.$ = ["ATTR", {}, yyvstack[yysp - 4], yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 12:
    /*! Production::    feature : OBJECTID ":" TYPEID */

    this.$ = ["ATTR", {}, yyvstack[yysp - 2], yyvstack[yysp], no_expr()];
    break;

case 13:
    /*! Production::    formals : %epsilon */

    this.$ = ["FORMALS", {}];
    break;

case 14:
    /*! Production::    formals : formals_nonempty */
case 19:
    /*! Production::    expressions : expressions_nonempty */

    this.$ = yyvstack[yysp];
    break;

case 15:
    /*! Production::    formals_nonempty : formal */

    this.$ = ["FORMALS", {}, yyvstack[yysp]];
    break;

case 16:
    /*! Production::    formals_nonempty : formals "," formal */
case 21:
    /*! Production::    expressions_nonempty : expressions "," expression */

    this.$ = appendChild(yyvstack[yysp - 2], yyvstack[yysp]);
    break;

case 17:
    /*! Production::    formal : OBJECTID ":" TYPEID */

    this.$ = ["FORMAL", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 18:
    /*! Production::    expressions : %epsilon */

    this.$ = ["EXPRESSIONS", {}];
    break;

case 20:
    /*! Production::    expressions_nonempty : expression */

    this.$ = ["EXPRESSIONS", {}, yyvstack[yysp]];
    break;

case 22:
    /*! Production::    expressions_semicolon : expression ";" */

    this.$ = ["EXPRESSIONS", {}, yyvstack[yysp - 1]];
    break;

case 24:
    /*! Production::    expressions_semicolon : expressions_semicolon error ";" */
case 35:
...
case 25:
    ...
    this.$ = ["CASES", {}, yyvstack[yysp]];
    break;

case 26:
    /*! Production::    cases : cases case */

    this.$ = appendChild(yyvstack[yysp - 1], yyvstack[yysp]);
    break;

case 27:
    /*! Production::    case : OBJECTID ":" TYPEID DARROW expression ";" */

    this.$ = ["BRANCH", {}, yyvstack[yysp - 5], yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 28:
    /*! Production::    expression : OBJECTID ASSIGN expression */

    this.$ = ["ASSIGN", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 29:
    /*! Production::    expression : expression "@" TYPEID "." OBJECTID "(" expressions ")" */

    this.$ = ["STATIC_DISPATCH", {}, yyvstack[yysp - 7], yyvstack[yysp - 5], yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 30:
    /*! Production::    expression : expression "." OBJECTID "(" expressions ")" */

    this.$ = ["DISPATCH", {}, yyvstack[yysp - 5], yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 31:
    /*! Production::    expression : OBJECTID "(" expressions ")" */

    this.$ = ["DISPATCH", {}, "self", yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 32:
    /*! Production::    expression : IF expression THEN expression ELSE expression FI */

    this.$ = ["COND", {}, yyvstack[yysp - 5], yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 33:
    /*! Production::    expression : WHILE expression LOOP expression POOL */

    this.$ = ["LOOP", {}, yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 34:
    /*! Production::    expression : "{" expressions_semicolon "}" */

    this.$ = ["BLOCK", {}, yyvstack[yysp - 1]];
    break;

case 36:
    /*! Production::    expression : LET nested_let */

    this.$ = ["NESTED_LET", {}, yyvstack[yysp]];
    break;

case 37:
    /*! Production::    expression : CASE expression OF cases ESAC */

    this.$ = ["TYPCASE", {}, yyvstack[yysp - 3], yyvstack[yysp - 1]];
    break;

case 38:
    /*! Production::    expression : NEW TYPEID */

    this.$ = ["NEW", {}, yyvstack[yysp]];
    break;

case 39:
    /*! Production::    expression : ISVOID expression */

    this.$ = ["ISVOID", {}, yyvstack[yysp]];
    break;

case 40:
    /*! Production::    expression : expression "+" expression */

    this.$ = ["PLUS", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 41:
    /*! Production::    expression : expression "-" expression */

    this.$ = ["SUB", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 42:
    /*! Production::    expression : expression "*" expression */

    this.$ = ["MUL", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 43:
    /*! Production::    expression : expression "/" expression */

    this.$ = ["DIVIDE", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 44:
    /*! Production::    expression : "~" expression */

    this.$ = ["NEG", {}, yyvstack[yysp]];
    break;

case 45:
    /*! Production::    expression : expression "<" expression */

    this.$ = ["LT", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 46:
    /*! Production::    expression : expression LE expression */

    this.$ = ["LEQ", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 47:
    /*! Production::    expression : expression "=" expression */

    this.$ = ["EQ", {}, yyvstack[yysp - 2], yyvstack[yysp]];
    break;
...
case 49:
    ...
    this.$ = ["PAREN", {}, yyvstack[yysp - 2]];
    break;

case 50:
    /*! Production::    expression : INT_CONST */

    this.$ = ["INT_CONST", {val: parseInt(yytext)} ];
    break;

case 51:
    /*! Production::    expression : BOOL_CONST */

    this.$ = ["BOOL_CONST", {val: JSON.parse(yytext)} ];
    break;

case 52:
    /*! Production::    expression : STR_CONST */

    this.$ = ["STR_CONST", {val: yytext} ];
    break;

case 53:
    /*! Production::    expression : OBJECTID */

    this.$ = ["OBJECTID", {val: yytext} ];
    break;

case 54:
    /*! Production::    nested_let : OBJECTID ":" TYPEID ASSIGN expression IN expression */
case 56:
    /*! Production::    nested_let : OBJECTID ":" TYPEID ASSIGN expression "," nested_let */

    this.$ = ["LET", {}, yyvstack[yysp - 6], yyvstack[yysp - 4], yyvstack[yysp - 2], yyvstack[yysp]];
    break;

case 55:
    /*! Production::    nested_let : OBJECTID ":" TYPEID IN expression */
case 57:
    /*! Production::    nested_let : OBJECTID ":" TYPEID "," nested_let */

    this.$ = ["LET", {}, yyvstack[yysp - 4], yyvstack[yysp - 2], no_expr(), yyvstack[yysp]];
    break;

case 58:
    /*! Production::    nested_let : error */
...
console.log('5059:', 'probe:', { stack_probe });
        var depth = 0;
...
console.log('5075:', 'probe:', { t, state, depth, symbol, lastEofErrorStateDepth });
            if (t[0]) {
...
console.log('5102:', 'set last depth:', { t, state, depth, symbol, lastEofErrorStateDepth });
                        ...
                        ++depth;
console.log('5116:', 'probe on EOF:', { t, state, depth, symbol, lastEofErrorStateDepth, stack_probe });
                        continue;
                    }
                }
console.log('5118:', 'probe RESULT:', { t, state, depth, symbol, lastEofErrorStateDepth, stack_probe });
                return depth;
            }
...
console.log('5132:', 'probe:', { t, state, depth, symbol, lastEofErrorStateDepth, stack_probe });
            ...
            state = sstack[stack_probe];
            ++depth;
console.log('5139:', 'probe:', { t, state, depth, symbol, lastEofErrorStateDepth, stack_probe });
        }
console.log('5141:', 'probe:', { t, state, depth, symbol, lastEofErrorStateDepth, stack_probe });
...
console.log('5164:', 'LOOP:', { newState, state, symbol, sp });

            // use default actions if available
            if (this.defaultActions[state]) {
                action = 2;
                newState = this.defaultActions[state];
console.log('5169:', 'defaultActions:', { newState, state, symbol });
            } else {
                ...
                newState = t[1];
                action = t[0];
console.log('5182:', 'actions:', { action, newState, state, t, symbol });
                ...
                if (!action) {
                    ...
                    if (recovering === ERROR_RECOVERY_TOKEN_DISCARD_COUNT && error_rule_depth >= 0) {
                        ...
                        preErrorSymbol = 0;
                        symbol = lex();
console.log('5274:', 'lex:', { symbol, preErrorSymbol, error_rule_depth });
...
console.log('5355:', 'performAction:', { r, yyval: yyval.$.errStr, yytext, sp, yyrulelen, recovering, ERROR_RECOVERY_TOKEN_DISCARD_COUNT });
...
console.log('5382:', 'defaultActions:', { newState });
                    } else {
                        t = (table[newState] && table[newState][symbol]) || NO_ACTION;
                        recoveringErrorInfo.state_stack[esp] = t[1];
console.log('5386:', 'actions:', { newState, symbol, esp, t });
                    }
                    ...
                    while (symbol) {
                        ...
                        if (this.defaultActions[state]) {
                            action = 2;
                            newState = this.defaultActions[state];
console.log('5425:', 'defaultActions:', { newState, symbol, state, action });
                        } else {
                            // read action for current state and first input
                            t = (table[state] && table[state][symbol]) || NO_ACTION;
                            newState = t[1];
                            action = t[0];
console.log('5431:', 'actions:', { newState, symbol, state, action });
                        ...
                        // shift:
                        case 1:
console.log('5480:', 'shift:', { newState, symbol, preErrorSymbol });
                            stack[sp] = symbol;
                        ...
                        // reduce:
                        case 2:
console.log('5550:', 'reduce:', { newState, symbol, preErrorSymbol });
...
console.log('5557:', 'performAction:', { r, yyval, yytext, sp, newState });
...
console.log('5636:', 'CONTINUE:', { action, newState, symbol, preErrorSymbol });
                    continue;
                }
...
console.log('5651:', 'SWITCH:', { action, newState, symbol });
            switch (action) {
            // catch misc. parse failures:
            default:
                // this shouldn't happen, unless resolve defaults are off
            ...
            case 2:
                ...
                r = this.performAction.call(yyval, yytext, newState, sp - 1, vstack);
console.log('5742:', 'performAction:', { r, yyval, yytext, sp, newState });
...
EOF: 1,
    ...
    performAction: function lexer__performAction(yy, yyrulenumber, YY_START) {
      ...
      yy.lex_error = () => {
        console.error(
          `Lexer error at line ${yy.curr_lineno}:\n${this.showPosition()}\n`,
          yy.error_msg
        );
      };
      ...
      case 10:
        /*! Conditions:: LINE_COMMENT */
        /*! Rule::       $ */
        this.popState();   // eof in this case is ok  
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = coolGho;
  exports.Parser = coolGho.Parser;
  exports.parse = function () {
    return coolGho.parse.apply(coolGho, arguments);
  };
...
exports.main = function (args) {
    ...
    var dst;
    try {
    	dst = exports.parser.parse(source);
    } catch (ex) {
	    console.log('parser b0rked:', ex.message);
    	dst = null;
    }
