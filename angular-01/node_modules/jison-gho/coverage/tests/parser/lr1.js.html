...
<html lang="en">
<head>
    <title>Code coverage report for tests/parser/lr1.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">tests/parser</a> lr1.js
    </h1>
    <div class='clearfix'>
...
322
323
324</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    var gen = new Jison.Generator(grammar, {type: "lr1"});
...
&nbsp;
    var source = '{"foo": "Bar", "hi": 42, "array": [1, 2, 3.004, 4], "false": false, "true": true, "null": null, "obj": {"ha": "ho"}, "string": "str\\ting\\"sgfg" }';
&nbsp;
    var parser = new Jison.Parser(grammar, {type: "lr"});
