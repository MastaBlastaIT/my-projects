...
/* parser generated by jison 0.6.0-189 */
...
var parser = {
    ...
    //   export *all* tables: ............. [object Object]
...
nonterminals_: {
  ...
  rules: {
    ...
    pgm: {
      1: {
        symbol: "pgm",
        handle: "expr (expr expr)+ expr expr expr expr expr expr expr expr expr expr expr11",
        nullable: false,
        id: 1,
        index: 1,
        state: 1,
  ...
  nonterminals: {
    ...
    pgm_repetition_plus: {
      ...
      productions: [
        ...
        {
          symbol: "pgm_repetition_plus",
          handle: "pgm_repetition_plus expr expr",
          nullable: false,
          id: 8,
          index: 1,
          state: -1,
  ...
  lalr_states: [
    ...
    },
    {
      ...
      production: {
        symbol: "pgm",
        handle: "⬤expr (expr expr)+ expr expr expr expr expr expr expr expr expr expr expr11",
        base_handle: "expr (expr expr)+ expr expr expr expr expr expr expr expr expr expr expr11",
        nullable: false,
        id: 1,
        index: 1,
        state: 0,
    ...
    rules: {
      ...
      "0:pgm": {
        1: {
          symbol: "0:pgm",
          base_symbol: "pgm",
          handle: "0:expr 2:(expr 3:expr)+ 4:expr 5:expr 6:expr 7:expr 8:expr 9:expr 10:expr 11:expr 12:expr 13:expr 14:expr11",
          base_handle: "expr (expr expr)+ expr expr expr expr expr expr expr expr expr expr expr11",
          nullable: false,
          id: 1,
          index: 1,
...
case 1:
    /*! Production::    pgm : expr "(expr" "expr)+" expr expr expr expr expr expr expr expr expr expr expr11 */

    // default action (generated by JISON mode classic/merge :: VT,VA,-,-,-,-,-,-):
    this.$ = yyvstack[yysp - 13];
    // END of default action (generated by JISON mode classic/merge :: VT,VA,-,-,-,-,-,-)
    
    
    return yyvstack[yysp] + '[' + $pgm_repetition_plus1.join(',') + ']' + $expr1;
    break;
...
default:
                // default action for all unlisted resolve states: 2, 3
...
/* lexer generated by jison-lex 0.6.0-189 */
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = test11;
  exports.Parser = test11.Parser;
  exports.parse = function () {
    return test11.parse.apply(test11, arguments);
  };
